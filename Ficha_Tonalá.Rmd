...
**`r Municipio_Ficha`** pertenece a la Región Centro, su población en 2020, según el Censo de Población y Vivienda 2020, era de 569,913 personas; **49.4%** hombres y **50.6%** mujeres; los habitantes del municipio representaban el **10.8%** del total regional.  
 
...
De 2015 a 2022 se han registrado **`r femi_total`** carpetas de **`r Delito_Ficha_4`** en el municipio de **`r Municipio_Ficha`**, el año con mayor registros es el **`r femi_año`** con **`r femi_max`**. De enero a septiembre 2022 se han contabilizado **`r femi_2022`** carpetas. La tasa de feminicidio por cada 100 mil mujeres es de **0.68** en el municipio.
```{r echo=FALSE, fig.width=10, fig.height=5}
